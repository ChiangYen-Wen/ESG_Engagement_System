...
> 可執行於 **Flask + Access** 資料庫上的簡易網站應用，用來管理 ESG 報告，包括「查詢」、「修改」以及「匯出」等功能。
...
✅ **範例連結，直接載下來就可以用了：https://drive.google.com/drive/folders/1dNrKkeXgRzzUz3KOg2xZah6Sdtdcdc6q?usp=drive_link**
